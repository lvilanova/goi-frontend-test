<template>
  <div class="todo-app" id="app">
    <div class="todo-content">
      ...
      <span class="counter unfinished-task">{{incompletedTasks.length}} {{task_counter1}}</span>
      <span class="counter finished-task">{{completedTasks.length}} {{task_counter2}}</span>
